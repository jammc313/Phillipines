...
# The model we are testing is the Alternative, with a single admixture event from Neanderthal into the shared ancestor of all Non-Africans, and two Denisovan admixture events. One into the ancestor of Papuans and Ayta and another more recent and private into Ayta. Basically we are looking to see if the observed pattern of reduced overlap in putative tracts for Denisovans in Ayta & Papuan could feasibly be due to ILS alone.
